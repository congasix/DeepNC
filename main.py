...
if __name__ == '__main__':
   ...
   # graph_validate_len /= len(graphs_validate)
    ...
    ### comment when doing training, for graph completion (test phase) only
    # p = 0.5
    ...
    #truth=nx.read_edgelist("ground_truth_ba.txt")
    ...
    #truth=nx.read_edgelist("ground_truth_ba180n.txt")
    #obs_graph=nx.read_edgelist("delgraph_ba180n_RN.txt")
    #obs_graph=deledges(obs_graph,0.2)
