...
class Args():
    def __init__(self):
        ...
        #self.graph_type = 'lfr'
        #self.graph_type = 'lfr_single'
        #self.graph_type = 'lfr2000'
        #self.graph_type = 'lfr_node2vec2'
        #self.graph_type = 'gnutella'
        #self.graph_type = 'facebook'
        #self.graph_type = 'facebook_single'
        #self.graph_type = 'whois'
        #self.graph_type = 'celegans'
        #self.graph_type = 'bio-grid'
        self.graph_type = 'protein'
        #self.graph_type = 'protein_95'
        #self.graph_type = 'protein_single'
        #self.graph_type = 'DD'
        ...
        #self.graph_type = 'barabasi2000'
        #self.graph_type = 'barabasi_95'
        #self.graph_type = 'barabasi_single'
        #self.graph_type = 'barabasi_small'
        #self.graph_type = 'citeseer'
        #self.graph_type = 'citeseer_single'
